...
const useResizeObserver = (
  callback: () => void,
  elA: React.RefObject<Element | null>,
  elB?: React.RefObject<Element | null>
) => {
  useEffect(() => {
    // Use feature detection via window with strict typing (no 'any')
    ...
    const refs = [elA, elB].filter(Boolean) as Array<React.RefObject<Element | null>>;
...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    const updateDimensions = useCallback(() => {
      ...
      const rect = seqRef.current ? seqRef.current.getBoundingClientRect() : null;
