...
import bg2p from '/assets/bg2p.png';
import bg2 from '/assets/bg2.mp4';
import bg3p from '/assets/bg3p.png';
import bg3 from '/assets/bg3.mp4';
import bg4p from '/assets/bg4p.png';
import bg4 from '/assets/bg4.mp4';
import ethereal from '/assets/Ethereal Abstract Flower.png';
import etherealVideo from '/assets/Sep_27__0626_32s_202509270641_kktxa.mp4';
